...
# $100 добавлен 30.08 под микрокапы: у LONGXIA на касании лежит семь долларов,
# и на такой книге даже $500 уходят вглубь. Без нижней ступени не видно, где
# кривая начинается — платит ли заявка вообще любого размера.
FILL_NOTIONALS = (100, 500, 2500, 10000)
