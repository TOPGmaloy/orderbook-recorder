...
#   XAU — золото: тонкий шаг, спред в 4 шага, совсем другой поток. По
#         выходным оборот падает в 4-5 раз при нулевом числе пустых часов —
#         бесплатная проверка, зависит ли эдж от плотности потока.
SYMBOLS = ["BTC_USDT", "ETH_USDT", "SOL_USDT", "XAU_USDT"]
